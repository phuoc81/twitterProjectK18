...
interface UserType {
  // dùng để mổ tả kiểu dữ liệu của 1 user
  // tạo ra 1 kiểu dữ liệu mới là UserType để dùng cho User
  _id?: ObjectId
...
export default class User {
  // dùng dể tạo ra 1 class User hoặc 1 object User
  // tạo ra 1 class User để dùng cho User trong database
  _id?: ObjectId
  name: string
  email: string
  date_of_birth: Date
